        ...
        <div class="container-fluid pt-5 p-0 ">
            <table class="table1  table-striped table-bordered table-hover table-sm">
                ...
                <tr>
					...
					<button class="btn2 btn1-bg-update toggle" data-toggle="modal" data-target="#contactmodal"><i class="fa-solid fa-user-plus" style="color: #ffffff;"></i> Add parameter</button></td>
                    ...
                    <div class="content1 rounded p-2" style="background-color: #f9f9f9 !important; 
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button type="button" class="border-0 btn2 btn1-bg-help" 
                                    ...
                                    onclick="openModalcontact('<?=$row->id;?>','<?=$row->item_id;?>')">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group row m-0 pt-1">
                                    ...
                                    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
										...
										<select id="parameter_id" name="parameter_id" value="<?=$_POST['parameter_id']?>" required style="width:220px;">

								<option></option>

								<?=foreign_relation('item_parameter_setup','id','id',$id,'item_id="'.$data->item_id.'" and status="Active"');?>
