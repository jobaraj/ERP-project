...
<script>
function fillMaxMin(select){
    let max = select.options[select.selectedIndex].getAttribute("data-max");
    let min = select.options[select.selectedIndex].getAttribute("data-min");
...
<td></td>
		...
		elseif($purchase_type=='2' && $master->qc_with_parameter == 'Yes'){
			...
			$res='select a.id, b.finish_goods_code as item_code,a.item_id, a. with_vat_rate, a.vat_amt,a.tax_amt, a. with_vat_amt, concat(b.item_name) as item_name,b.unit_name,a.grand_amount, a.qty as total_unit,a.rate, a.amount,"x" from purchase_invoice a,item_info b where b.item_id=a.item_id and a.po_no='.$po_no;
        ...
        <div class="container-fluid pt-5 p-0 ">
            <table class="table1  table-striped table-bordered table-hover table-sm">
                ...
                <tr>
					...
					<button class="btn2 btn1-bg-update toggle" data-toggle="modal" data-target="#contactmodal_<?=$data->id?>"><i class="fa-solid fa-user-plus" style="color: #ffffff;"></i> Add parameter</button></td>
                ...
                <div class="col-sm-2 p-1" style="zoom: 80%">
                    <div class="content1 rounded p-2" style="background-color: #f9f9f9 !important; 
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button type="button" class="border-0 btn2 btn1-bg-help" 
                                    data-toggle="modal" data-target="#contactmodal_<?=$data->id?>"
                                    onclick="openModalcontact('<?=$row->id;?>','<?=$data->item_id;?>')">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form id="contactformidnew" method="post">
                            <div class="modal-body">
                                ...
                                <div class="form-group row m-0 pt-1">
                                    ...
                                    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                                        <input class="form-control req" name="item_id" id="item_id" value="<?=find_a_field('item_info','item_id','item_id="'.$data->item_id.'"');?>" readonly="readonly"> 
                                    </div>
                                </div>
							...
							<select id="parameter_id" name="parameter_id" required style="width:220px;" onchange="fillMaxMin(this)">
    <option value="">Select Parameter</option>
    <?php
    $params = mysqli_query($conn,
        "SELECT i.id, i.maximum, i.minimum, p.parameter_name
         FROM item_parameter_setup i
         JOIN parameter_info p ON i.parameter_id=p.id
    ...
    ?>
                                ...
                                <div class="form-group row m-0 pt-1">
                                    ...
                                    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                                        ...
                                        <input class="form-control req" name="maximum" id="maximum" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group row m-0 pt-1">
                                    ...
                                    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                                        <input type="text" name="minimum" id="minimum" value="" class="form-control req" />
                                    </div>
                                </div>
