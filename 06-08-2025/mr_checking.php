...
$req_all = find_all_field('requisition_master','','req_no="'.$_GET['req_no'].'"');
                    ...
                    <div class="container n-form2">
                        <div class="form-group row m-0 pb-1">
                         ...
                         <select name="depot" id="depot">
                      			<? foreign_relation('warehouse','warehouse_id','warehouse_name',$depot,'warehouse_id="'.$req_all->warehouse_id.'"');?>
						</select>
                            </div>
                        </div>
    ...
    <form action="" method="post" name="cloud" id="cloud">
        ...
        <div class="container-fluid pt-5 p-0 ">
            ...
            <table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<?
						$res='select a.id,b.item_name as item_name,a.qoh as stock_qty,a.last_p_qty as last_pur_qty,a.last_p_date as last_pur_date,a.qty,a.specification,"x" from requisition_order a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no; 
