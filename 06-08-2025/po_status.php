                ...
                <table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<? 
                        ...
                        <tr bgcolor="<?=$line_color?>">
							...
							elseif($row->md_approve<1 && $row->complete_approve> 0 && $row->gm_approver>1){
							...
							//echo "<span style='color:blue;font-weight:bold;'>ED(RCL) ($buh_user)</span>";
							//}
							...
							elseif($row->buh_approve<1 && $row->complete_approve<1 && $row->gm_approver<1 && $approve_layer<1){
							echo "<span style='color:red;font-weight:bold;'>GM(Operation) Approval Pending</span>";
							}
							elseif($row->buh_approve<1 && $row->complete_approve<1 && $approve_layer>0){
							echo "<span style='color:red;font-weight:bold;'>ED(RCL) Approval Pending</span>";
							}
