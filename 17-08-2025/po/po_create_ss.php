...

{
		...
		if($_POST['vaat_include']=='Including'){
			...
			$vat_rate=number_format((($_POST['rate']/(100+$_POST['vaat']))*$_POST['vaat']),2,'.','');
			...
			$_POST['with_vat_amt'] =number_format(($_POST['with_vat_rate'] * $_POST['qty']),2,'.','');
		}else{
		...
		$_POST['tax_amt']=number_format(($tax_rate*$_POST['qty']),2,'.','');
...
<div class="form-group col-sm-4 col-md-4 col-lg-4 col-xl-4 row m-0 pb-1">
				...
				<div class="form-group col-sm-4 col-md-4 col-lg-4 col-xl-4 row m-0 row m-0 pb-1">
						...
						<div class="form-group col-sm-4 col-md-4 col-lg-4 col-xl-4 row m-0 pb-1">
							<? $field = 'req_no'; ?>
							<label for="<?= $field ?>"
								class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Requisition No </label>
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
				...
				<div class="form-group col-sm-4 col-md-4 col-lg-4 col-xl-4 row m-0 pb-1">
						...
						<? $field='purchase_type';?>
                            ...
                            <label for="vat" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Vat(%)</label>

                            <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 p-0 ">

                                

								<input name="vat" type="text" id="vat" value="">
                            ...
                            <label for="vat_include" class="col-sm-1 col-md-1 col-lg-1 col-xl-1 p-0  d-flex justify-content-end align-items-center bg-form-titel-text pr-2 pl-2"> ** </label>

                            <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 p-0 pr-0">

                                

								<select name="vat_include" id="vat_include" value="" required="">
						...
						<div class="form-group col-sm-4 col-md-4 col-lg-4 col-xl-4 row m-0 pb-1">
                            ...
                            <label for="tax" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Tax(%)</label>
                            ...
                            <label for="tax_include" class="col-sm-1 col-md-1 col-lg-1 col-xl-1 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text pr-2 pl-2">**</label>

                            <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 p-0 pr-0">

                                

								<select name="tax_include" id="tax_include" value="" required="">
											<option value="Including">Including</option>
    										<option value="Excluding">Excluding</option>
									</select>
						...
						<div class="form-group col-sm-4 col-md-4 col-lg-4 col-xl-4 row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0" id="data-box">
						...
						<? $field='warehouse_id'; $table='warehouse';$get_field='warehouse_id';$show_field='warehouse_name'; if($$field=='') $$field=$req_all->warehouse_id;?>
                            ...
                            <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end right pr-1 bg-form-titel-text">Warehouse</label>
						...
						<div class="form-group col-sm-4 col-md-4 col-lg-4 col-xl-4 row m-0 pb-1">
						 ...
						 <? $field='file_upload';?>
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
									  ...
									  <a href="../../../controllers/uploader/upload_view.php?proj_id=saaserp&&folder=purchase&&name=<?=$file_upload;?>" target="_blank">
...
$TandC .= '</div>';
 ...
 <script src="//cdn.ckeditor.com/4.14.1/standard/ckeditor.js"></script>
	...
	<? if ($_SESSION[$unique] > 0 && $_SESSION['selected_req_no']>0) { ?>
			<?
...
<? foreign_relation('cost_center','id','center_name',$cc_code,"1");?>
		...
		<? if($$unique>0 && $_SESSION['selected_req_no']<1){?>
		 ...
		 <? 
			...
			$res='select a.id, b.finish_goods_code as item_code, a. with_vat_rate, a.vat_amt,a.tax_amt, a. with_vat_amt, concat(b.item_name) as item_name,b.unit_name, a.qty as total_unit,a.rate, a.amount,"x" from purchase_invoice a,item_info b where b.item_id=a.item_id and a.po_no='.$po_no;
...
<td ><?=number_format($tot_with_vat_amt,2);?></td>
<td></td>
</tr>
