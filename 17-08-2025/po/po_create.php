...
$invoice_id=find_a_field('purchase_invoice','id','id="'.$iddd.'"');
$_POST['po_details_id']=$invoice_id;
        ...
        <div class="container-fluid pt-5 p-0 ">
            <table class="table1  table-striped table-bordered table-hover table-sm">
                ...
                <tr>
					...
					<td><button class="btn2 btn1-bg-update toggle" data-toggle="modal" data-target="#contactmodal"><i class="fa-solid fa-user-plus" style="color: #ffffff;"></i> Add parameter</button></td>
					...
					<div class="row m-0 p-0">
                        <?php
				$sqlTasks = "SELECT * FROM item_parameter_details  WHERE po_no = $po_no;";
                            ...
                            <div class="col-sm-12 p-3">
                                <div class="content1 rounded p-2" style="background-color: #f9f9f9 !important; box-shadow: rgba(17, 17, 26, 0.05) 0px 1px 0px, rgba(17, 17, 26, 0.1) 0px 0px 8px;">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h1>
                                    ItemName: <strong style="font-weight: 600;"><?=$row->item_id;?></strong>
                                </h1>
                                        <button type="button" class="border-0 btn2 btn1-bg-help" data-toggle="modal" data-target="#contactmodal" onclick="openModalcontact('<?=$row->id;?>', '<?=$row->item_id;?>', '<?=$row->item_id;?>','<?=$row->item_id;?>','<?=$row->item_id?>')">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </button>
                                    </div>
                                    <div class="social">
                                        <h1>
                                    Parameter: <strong style="font-weight: 600;"><?=$row->parameter_id?></strong>
                                </h1>
                                        <h1>
                                    <i class="fa-duotone fa-phone" style="--fa-primary-color: #4e8efd; --fa-secondary-color: #18af22;"></i> <strong style="padding-left: 5px; font-weight: 600;"><?=$row->maximum?></strong>
                                </h1>
                                    </div>
                                    <div class="social">
                                        <h1>
                                    <i class="fa-duotone fa-envelope" style="--fa-primary-color: #054ac2; --fa-secondary-color: #07922a;"></i><strong style="padding-left: 5px; font-weight: 600;"><?=$row->minimum?></strong>
                                </h1>
                                    </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group row m-0 pt-1">
                                    ...
                                    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                                        ...
                                        <input class="form-control req" name="parameter_id" id="parameter_id">
                                    </div>
                                </div>
