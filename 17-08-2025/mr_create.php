...
var qty=((document.getElementById('order_qty').value)*1);


var stk=((document.getElementById('cwh_qoh').value)*1);
		...
		id="req_for2" value="<?=find_a_field('warehouse','warehouse_name','warehouse_id="'.$_SESSION['user']['depot'].'"')?>" readonly />
		  ...
		  <div class="container n-form2">
            ...
            <div class="form-group pb-1 row m-0">
					...
					<? $post_warehouse=find_a_field('master_requisition_master','warehouse_id','req_no="'.$_POST['req_for'].'"');?>
...
<td align="center"><input name="order_qty" type="number" step="any" class="input3" id="order_qty"  maxlength="100" style="width:120px;" required onchange="calculation();"/></td>
